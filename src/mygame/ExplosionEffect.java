...
public class ExplosionEffect {
    ...
    public ExplosionEffect(Node explosionEffectWrapper, AssetManager manager){
        if (explosionEffectWrapper == null || manager == null) {
            throw new IllegalArgumentException();
        }
        this.assetManager = manager;
        this.explosionEffect = explosionEffectWrapper;
        System.out.println("Constructing ExplosionEffect.");
        this.initialize();
    }
...
//        shockwave.setRandomAngle(true);
    ...
    private void initialize(){
        ...
        System.out.println("Initializing ExplosionEffect.");
    }
    public boolean triggerEffect(float tpf, float speed, boolean trigger){
        System.out.println("explosionEffect.triggerEffect was called with tpf: " + tpf +" , speed: " + speed + " , trigger: " + trigger);
        if (trigger == true) {
            time += tpf / speed;
            if (time > 1f && state == 0){
